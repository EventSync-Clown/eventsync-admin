            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-16">
                ...
                <div className="text-center max-w-2xl mb-14">
                    <h1 className="text-5xl md:text-6xl font-black tracking-tight text-[#1a1d1a] leading-tight">
                        Bienvenue sur{" "}
                        <span className="text-[#c4a973]">
                            Tendak'Anina
                        </span>
                    </h1>

                    <p className="mt-5 text-lg md:text-xl text-[#5f7468] leading-relaxed">
                        Une plateforme moderne pour vivre vos événements,
                        connecter les participants et gérer chaque instant
                        avec élégance.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-6xl w-full">
                    ...
                    <Link href="/" className="group relative">
                        ...
                        <div className="relative h-full overflow-hidden rounded-[32px] border border-white/40 bg-white/70 backdrop-blur-xl p-10 shadow-[0_10px_40px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)]">                            <div className="absolute top-0 right-0 w-40 h-40 bg-[#5f7468]/10 blur-3xl rounded-full"></div>
                            ...
                            <div className="relative w-20 h-20 rounded-3xl bg-[#5f7468]/10 flex items-center justify-center mb-8 transition-all duration-500 group-hover:bg-[#5f7468] group-hover:rotate-6">
                                <Users
                                    size={38}
                                    className="text-[#5f7468] group-hover:text-white"
                                />
                            </div>

                            <h2 className="text-3xl font-bold text-[#1a1d1a] mb-4">
                                Participant
                            </h2>

                            <p className="text-gray-600 leading-relaxed text-lg mb-10">
                                Consultez les événements en temps réel,
                                échangez avec la communauté et profitez
                    ...
                    <Link href="/dashboard" className="group relative">
                        ...
                        <div className="relative h-full overflow-hidden rounded-[32px] border border-white/40 bg-[#1a1d1a] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.10)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
                            ...
                            <div className="relative w-20 h-20 rounded-3xl bg-[#c4a973]/10 border border-[#c4a973]/20 flex items-center justify-center mb-8 transition-all duration-500 group-hover:bg-[#c4a973] group-hover:rotate-6">
                                <LayoutDashboard
                                    size={38}
                                    className="text-[#c4a973] group-hover:text-[#1a1d1a]"
                                />
                            </div>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg mb-10">
                                Pilotez les sessions, gérez les intervenants
                                et suivez l’activité des participants
                                depuis un dashboard avancé.
                            </p>
                            ...
                            <div className="inline-flex items-center gap-3 text-[#c4a973] font-semibold text-lg">
                                ...
                                <div className="w-10 h-10 rounded-full bg-[#c4a973]/10 border border-[#c4a973]/20 flex items-center justify-center transition-all duration-300 group-hover:bg-[#c4a973]">
                                    <ArrowRight
                                        size={20}
                                        className="group-hover:text-[#1a1d1a]"
                                    />
                                </div>
                            </div>
